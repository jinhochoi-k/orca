...
// ─── Repo ────────────────────────────────────────────────────────────
export type RepoKind = 'git' | 'perforce' | 'folder'
...
export type Repo = {
  ...
  /** Prevents Perforce submit while leaving local changelist and shelve workflows available. */
  perforceSubmitDisabled?: boolean
